...
<div style="background-color: #eee; text-align: center; padding: 20px 0px ">
  ...
  <div style="float: left; padding-left: 400px; text-align: left">
  		...
  		<div style="color: gray; text-align: left">
  			...
  			EMAIL : admin@moamoa.kr | FAX : 00-000-000 <br/>
  			주소: 중고모아 어딘가 어디가로 123-57
  		</div>
  </div>
  <div style="float: left; padding-left: 50px; text-align: left">
  		<b style="text-align: left">고객센서</b><br/>
  		<div style="font-size: 2em"><b>0000-0000</b></div>
  		<div style="color: gray; text-align: left">
